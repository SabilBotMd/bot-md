...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.versibot = '2.2.4'
        global.run = `꧁ 𝙍𝙪𝙣𝙩𝙞𝙢𝙚: ${global.u} ꧂`
   ...
   await conn.sendButtonDoc(id, text, wm, action == 'add' ? 'Welcome' : 'Byee', action === 'add' ? '.intro' : 'MadeXyz', fkontak,{
...
global.dfail = async (type, m, conn) => {
    ...
    let msg = {
        rowner: '_𝑷𝒆𝒓𝒊𝒏𝒕𝒂𝒉 𝑰𝒏𝒊 𝑯𝒂𝒏𝒚𝒂 𝑼𝒏𝒕𝒖𝒌 𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓 𝑩𝒐𝒕!_',
        owner: '_𝑷𝒆𝒓𝒊𝒏𝒕𝒂𝒉 𝑰𝒏𝒊 𝑯𝒂𝒏𝒚𝒂 𝑼𝒏𝒕𝒖𝒌 𝑶𝒘𝒏𝒆𝒓 𝑩𝒐𝒕!_',
        mods: '_𝑷𝒆𝒓𝒊𝒏𝒕𝒂𝒉 𝑰𝒏𝒊 𝑯𝒂𝒏𝒚𝒂 𝑼𝒏𝒕𝒖𝒌 𝑴𝒐𝒅𝒆𝒓𝒂𝒕𝒐𝒓 𝑩𝒐𝒕!_',
        premium: '_𝑭𝒊𝒕𝒖𝒓 𝑰𝒏𝒊 𝑯𝒂𝒏𝒚𝒂 𝑻𝒆𝒓𝒔𝒆𝒅𝒊𝒂 𝑼𝒏𝒕𝒖𝒌 *𝑷𝒓𝒆𝒎𝒊𝒖𝒎!*_',
        group: '_𝑭𝒊𝒕𝒖𝒓 𝑰𝒏𝒊 𝑯𝒂𝒏𝒚𝒂 𝑫𝒂𝒑𝒂𝒕 𝑫𝒊𝒈𝒖𝒏𝒂𝒌𝒂𝒏 𝑫𝒂𝒍𝒂𝒎 𝑮𝒓𝒐𝒖𝒑!_',
        private: '_𝑭𝒊𝒕𝒖𝒓 𝑰𝒏𝒊 𝑯𝒂𝒏𝒚𝒂 𝑩𝒊𝒔𝒂 𝑫𝒊𝒈𝒖𝒏𝒂𝒌𝒂𝒏 𝑫𝒊𝑷𝒓𝒊𝒗𝒂𝒕𝒆 𝑪𝒉𝒂𝒕!_',
        admin: '_𝑭𝒊𝒕𝒖𝒓 𝑰𝒏𝒊 𝑯𝒂𝒏𝒚𝒂 𝑩𝒊𝒔𝒂 𝑫𝒊𝒈𝒖𝒏𝒂𝒌𝒂𝒏 𝑨𝒅𝒎𝒊𝒏 𝑮𝒓𝒐𝒖𝒑!_',
        botAdmin: '_𝑱𝒂𝒅𝒊𝒌𝒂𝒏 𝑩𝒐𝒕 𝑺𝒆𝒃𝒂𝒈𝒂𝒊 *𝑨𝒅𝒎𝒊𝒏* 𝑼𝒏𝒕𝒖𝒌 𝑴𝒆𝒏𝒈𝒈𝒖𝒏𝒂𝒌𝒂𝒏 𝑷𝒆𝒓𝒊𝒏𝒕𝒂𝒉 𝑰𝒏𝒊!_',
  ...
  contextInfo: { 
    externalAdReply :{
    showAdAttribution: true,
    mediaUrl: 'https://wa.me/687965044',
    mediaType: 2,
    description: desl, 
    title: run,
    body: wmo,
    thumbnail: await(await fetch(img)).buffer(),
    sourceUrl: 'https://wa.me/687965044'
     }}
  })
}
